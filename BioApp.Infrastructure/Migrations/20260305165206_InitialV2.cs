        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAdd = table.Column<decimal>(type: "decimal(10,2)", nullable: false, defaultValue: 0m)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShowFormats", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Standard")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuditoriumId = table.Column<int>(type: "int", nullable: false),
                    ShowFormatId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Screenings_ShowFormats_ShowFormatId",
                        column: x => x.ShowFormatId,
                        principalTable: "ShowFormats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                table: "ShowFormats",
                columns: new[] { "Id", "Name", "PriceAdd" },
                values: new object[] { 2, "3D", 30m });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingItems_BookingId_ProductId",
                table: "BookingItems",
                columns: new[] { "BookingId", "ProductId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Screenings_ShowFormatId",
                table: "Screenings",
                column: "ShowFormatId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seats_AuditoriumId_SeatRow_SeatNumber",
                table: "Seats",
                columns: new[] { "AuditoriumId", "SeatRow", "SeatNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ShowFormats_Name",
                table: "ShowFormats",
                column: "Name",
                unique: true);
